...
namespace RPD
{
	...
	static const std::unordered_map<SamplerTypes, SamplerInfo, EnumClassesHash> samplersInfo =
	{
		...
		{SamplerTypes::Comparison, {D3D12_SHADER_VISIBILITY_PIXEL, 0u, D3D12_FILTER_COMPARISON_MIN_MAG_MIP_POINT, D3D12_REQ_MAXANISOTROPY, D3D12_TEXTURE_ADDRESS_MODE_BORDER, D3D12_STATIC_BORDER_COLOR_OPAQUE_BLACK, D3D12_COMPARISON_FUNC_GREATER_EQUAL}},
	};
}