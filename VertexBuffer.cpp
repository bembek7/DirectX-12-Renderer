...
VertexBuffer::VertexBuffer(Graphics& graphics, const std::vector<DirectX::XMFLOAT3>& vertices, const unsigned int vertexSize) :
	vertexSize(vertexSize)
{
	D3D11_BUFFER_DESC vertexBufferDesc = {};
	vertexBufferDesc.BindFlags = D3D11_BIND_VERTEX_BUFFER;
	vertexBufferDesc.Usage = D3D11_USAGE_DEFAULT;
	vertexBufferDesc.ByteWidth = (UINT)vertices.size() * sizeof(DirectX::XMFLOAT3);
